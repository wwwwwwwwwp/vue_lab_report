  ...
  <div class="fullMain">
    ...
    <div class="mainbBg">
      ...
      <group>
        ...
        <calendar class="times_small" :readonly="readonly" v-model="selVal" :title="title" :placeholder="placeholder" @on-show="log('show')" @on-hide="log('hide')"></calendar>
      </group>
      ...
      <scroller lock-x scrollbar-y height="calc(100% - 240px)" :class="displayNone">
        <div class="groupDiv">
          <div class="chatDiv">
            <div>
              <span class="chatTime">2018-08-02 星期四</span>
              项目：物联网平台<br>
              .....<br>
              学习：论文<br>
              .....<br>
  ...
  export default {
    ...
    data(){
      return{
        ...
        tjTitle: '条件(仅包括组内成员)',
        tjValue:[],
        tjList: [['java', '机器学习', '物联网', '2017级', '其他', '不告诉你']],
        tjP:"搜索/选择",
